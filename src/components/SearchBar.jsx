...
const SearchBar = () => {
  ...
  return (
    <div className="glass-panel w-[90%] md:w-fit mx-auto rounded-[2rem] md:rounded-full px-4 py-3 xl:py-4 flex flex-col md:flex-row items-center gap-4 md:gap-8 shadow-2xl z-50">
      ...
      <div className="flex items-center gap-4 px-4 py-2 border-b md:border-b-0 md:border-r border-gray-700/50 hover:bg-white/5 rounded-3xl transition-colors cursor-pointer min-w-[200px]">
        ...
        <div className="flex-1">
          ...
          <input 
            ...
            className="text-sm font-medium text-white bg-transparent outline-none placeholder-white w-full"
          />
        </div>
      </div>
      ...
      <div className="flex items-center gap-4 px-4 py-2 border-b md:border-b-0 md:border-r border-gray-700/50 hover:bg-white/5 rounded-3xl transition-colors cursor-pointer min-w-[180px]">
        ...
        <div className="flex-1">
          ...
          <input 
            type="date"
            className="text-sm font-medium text-white bg-transparent outline-none w-full cursor-pointer [&::-webkit-calendar-picker-indicator]:filter [&::-webkit-calendar-picker-indicator]:invert"
          />
        </div>
      </div>
