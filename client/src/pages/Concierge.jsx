...
const Concierge = () => {
  ...
  return (
    <div className="bg-[var(--color-brand-dark)] min-h-screen pt-32 pb-24 px-6 md:px-12 lg:px-24 relative overflow-hidden">
      ...
      <div className="max-w-[1400px] mx-auto relative z-10 flex flex-col lg:flex-row gap-16 items-center min-h-[70vh]">
        <div className="lg:w-1/2">
          <p className="text-blue-400 text-xs font-bold tracking-[0.3em] uppercase mb-4">Luxe Concierge</p>
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-8 tracking-wide leading-tight">
          ...
          <p className="text-gray-400 text-base leading-relaxed mb-10 max-w-xl">
            ...
            <br /><br />
            Available 24/7, our global network of lifestyle managers ensures that wherever you are, you receive the highest standard of service.
          </p>
          <button 
            onClick={() => navigate('/login')}
            className="flex items-center justify-center gap-3 bg-white text-black px-8 py-4 rounded-full text-sm font-bold tracking-widest uppercase hover:bg-gray-200 transition-colors shadow-[0_0_20px_rgba(255,255,255,0.2)] w-fit"
          >
